    ...
    Box(
        ...
        Row(
            ...
            SelectorButtons(
                ...
                contentColor = AppTheme.colors.actionsSurface,
...
@Composable
fun Cart(
    modifier: Modifier = Modifier, totalPrice: String, onClicked: () -> Unit
) {
    Surface(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Add To Cart", style = AppTheme.typography.titleSmall
                )
                Text(
                    text = totalPrice,
